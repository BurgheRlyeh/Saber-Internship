...
void BuildSolarSystemScene(
	...
	const size_t sun{ addBody(
		...
		{ BodyVisual::Shape::Sphere, L"Kitty.dds", L"BrickNM.dds" }
	) };
	...
	addBody(
		...
		{ BodyVisual::Shape::Sphere, L"Brick.dds", L"BrickNM.dds" }
	);
	...
	const size_t planetWithTwoMoons{ addBody(
		...
		{ BodyVisual::Shape::Sphere, L"grassAlbedo.dds", L"grassNormal.dds" }
	) };
	addBody(
		{
		...
		{ BodyVisual::Shape::Sphere, L"cube.dds", L"BrickNM.dds" }
	);
	addBody(
		{
			.parent{ planetWithTwoMoons },
	...
	const size_t boxPlanet{ addBody(
		{
			.parent{ sun },
			.orbitRadius{ 20.f }, .orbitSpeed{ 0.26f }, .orbitAngle{ XM_PI },
			.spinSpeed{ 0.75f }, .scale{ 1.1f }
		},
		{ BodyVisual::Shape::Box, L"barbarian_diffuse.dds", L"barb2_n.dds" }
	) };
	addBody(
		{
			.parent{ boxPlanet },
	...
	const size_t tiltedPlanet{ addBody(
		{
			.parent{ sun },
	...
	addBody(
		...
		{ BodyVisual::Shape::Box, L"cube.dds", L"BrickNM.dds" }
	);
	...
	addBody(
		...
		{ BodyVisual::Shape::Box, L"Kitty.dds", L"BrickNM.dds" }
	);
