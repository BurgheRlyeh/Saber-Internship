...
public:
	...
	Texture(
		...
		pDevice->GetCopyableFootprints(&desc, 0, 1, 0, nullptr, nullptr, nullptr, &textureMemorySize);
		...
		UpdateSubresources(pCommandList->m_pCommandList.Get(), m_resource.Get(), textureBufferUploadHeap.Get(), 0, 0, 1, &textureData);
		...
		pDevice->CreateShaderResourceView(m_resource.Get(), &srvDesc, m_pTextureDescHeap->GetCPUDescriptorHandleForHeapStart());
	}
};