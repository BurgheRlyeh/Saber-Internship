...
class SimplePostProcessing : public PostProcessing {
public:
    static std::shared_ptr<PostProcessing> CreateSimplePostProcessing(
        ...
        pp->InitMaterial(
            ...
            RootSignatureData{
                ...
                L"SimplePostProcessingRootSignature"
            },
            ShaderData{
                pShaderAtlas,
                L"PostProcessingVS.cso",
                L"PostProcessingPS.cso"
            },
            PipelineStateData{
                pPSOLibrary,
