...
class TemporaryPostProcessingForDeferredShading : PostProcessing {
public:
    static std::shared_ptr<PostProcessing> Create(
        Microsoft::WRL::ComPtr<ID3D12Device2> pDevice,
        std::shared_ptr<Atlas<Mesh>> pMeshAtlas,
        ...
        pp->InitMaterial(
            ...
            RootSignatureData{
                pRootSignatureAtlas,
                CreateRootSignatureBlob(pDevice),
                L"PostProcessingDeferredShadingRootSignature"
            },
            ShaderData{
                pShaderAtlas,
                L"PostProcessingDeferredShadingVS.cso",
                L"PostProcessingDeferredShadingPS.cso"
            },
            PipelineStateData{
                pPSOLibrary,
                CreatePipelineStateDesc()
